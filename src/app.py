...
activities = {
    ...
    "Basketball Team": {
        "description": "Team practice and tournaments for students who love basketball",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["nina@mergington.edu", "alex@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training and lap practice for all skill levels",
    ...
    "Drama Club": {
        "description": "Rehearse and perform plays, scenes, and improvisation exercises",
